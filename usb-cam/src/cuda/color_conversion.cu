...
__global__ void yuyv2rgb(char *YUV, char *RGB, int NumPixels)
{
...
void yuyv2rgb_cuda(char *YUV, char *RGB, int NumPixels, int num_blocks, int block_size) {
    yuyv2rgb<<<num_blocks, block_size>>>(YUV, RGB, NumPixels);
